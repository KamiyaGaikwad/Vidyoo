...
export default function Wl_VideoCard({video}){
    const {state,dispatch} = useVideos();
    const {liked} = state;
    const [col,setCol] = useState("video-like-btn");
    console.log(col)
    return(
